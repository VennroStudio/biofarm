...
final readonly class LoyaltyPageUnifier
{
    ...
    public function unify(): LoyaltyPageView
    {
        ...
        return new LoyaltyPageView(
            ...
            orderBonusPercent: $this->settings->int('order_bonus_percent'),
            ...
            referralPercent: $this->settings->int('referral_percent'),
            welcomeBonusEnabled: $this->settings->bool('welcome_bonus_enabled'),
