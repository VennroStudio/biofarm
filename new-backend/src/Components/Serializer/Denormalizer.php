...
final readonly class Denormalizer
{
     ...
     */
    public function denormalize(array|bool|float|int|object|string|null $data, string $type): object
    {
        /** @var T */
     ...
     * @throws ExceptionInterface
     */
    public function denormalizeStrict(array|bool|float|int|object|string|null $data, string $type): object
    {
        /** @var T */
        return $this->assertObject(
     ...
     * @return T
     */
    private function assertObject(array|bool|float|int|object|string|null $result, string $type): object
    {
        if (!\is_object($result)) {
