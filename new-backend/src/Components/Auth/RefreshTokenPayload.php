...
final readonly class RefreshTokenPayload
{
    ...
    private static function requirePositiveInt(array|bool|float|int|object|string|null $value): int
    {
    ...
    private static function requireNonEmptyString(array|bool|float|int|object|string|null $value): string
    {
